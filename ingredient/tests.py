...
class TestIngredients(TestCase):
    ...
    def setUp(self):
        ...
        self.recipe = Recipe.objects.create(id=1, category=self.category, title='django beginners', description='lorem', author=user, published=False,
                                            price='20.00', image='default.png', method='lorem')
